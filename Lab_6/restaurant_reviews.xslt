...
>
  ...
  <xsl:template match="/">
    ...
    <xsl:template match="restaurant">
        ...
        <h4>Summary</h4>
        <div style="margin-left: 20px"><xsl:value-of select="Summary" /></div>
        <h4 style="">Rating: <span style="margin-left: 5px"><xsl:value-of select="Rating" />
          </span>
        </h4>
        <h4>Menu</h4>
        <div style="margin-left: 20px">
          <table border="2" style="width: 80%">
            <tr>
              <th>Description</th><th>Quentity</th><th>Price</th>
            </tr>
            <tr>
